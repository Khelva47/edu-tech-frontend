    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex justify-between items-start">
          ...
          <Button aschild="true" className="mt-2 bg-blue-600 hover:bg-blue-700">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Button aschild="true" size="sm" className="flex-1">
                      <Link href={`/student/${student.student_id}`}>View Details</Link>
                    </Button>
                    <Button aschild="true" variant="outline" size="sm" className="flex-1 bg-transparent">
